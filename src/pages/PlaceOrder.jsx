...
const PlaceOrde = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 sm:pt-4 border-t min-h-[80vh] pt-5'>
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input type="text" placeholder='Email Adress'  className='border border-gray-300 rounded py-1.5 px-3.5 w-full'/>
        ...
        <div className='flex  gap-3'>
            ...
            <input type="number" placeholder='Mobile Number'  className='border border-gray-300 rounded py-1.5 px-3.5 w-full'/>
      </div>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={() => setMethod('cash')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                <p className={`min-w-3.5 h-3 border rounded-full ${method ==='cash' ? 'bg-green-400' : ''}`}></p>
